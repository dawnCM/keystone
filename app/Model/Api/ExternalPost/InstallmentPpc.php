...
class InstallmentPpc extends AppModel {
	public $actsAs = array('AuditLog.Auditable');
	public $name = 'InstallmentPpc';
	...
	public function addDependencies(){
		...
		if($this->data['InstallmentPpc']['CoApplicant'] == 'Yes'){
		...
		//Add CoApp Address
		if($this->data['InstallmentPpc']['CoAppSameAddr'] == 'Yes'){
