...
class PersonalLoanPpc extends AppModel {
	public $actsAs = array('AuditLog.Auditable');
	public $name = 'PersonalLoanPpc';
	...
	public function addDependencies(){
		...
		if($this->data['PersonalLoanPpc']['CoApplicant'] == 'Yes'){
		...
		//Add CoApp Address
		if($this->data['PersonalLoanPpc']['CoAppSameAddr'] == 'Yes'){
	...
	public function buildPost(){
		...
		$data = $this->data['PersonalLoanPpc'];
