...
class Installment extends AppModel {
	...
	public function addDependencies(){
		...
		if($this->data['Installment']['CoApplicant'] == 'Yes'){
		...
		//Add CoApp Address
		if($this->data['Installment']['CoAppSameAddr'] == 'Yes'){
	...
	public function buildPost(){
		...
		if(empty($data['AgreePhone'])){
			$data['AgreePhone'] = 'false';
		}
		
	$main = array(	'loan_amount_personal' 	=>	 $data['LoanAmountPersonal'],
					'loan_amount' 	=>	 $data['LoanAmountPersonal'],
	...
	public function doNotMatch($check, $compare){
		...
		return ($this->data['Installment'][$compare] != $value);
	}
